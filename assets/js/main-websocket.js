...
if (button) {
	button.addEventListener("click", function (eventClick) {
        console.log('On envoie une question');
...
socket.on("questionSent", receiveQuestion);
socket.on("questionStatus", changeQuestionStatus);
socket.on("moduleStatus", changeModuleStatus);
socket.on("eventStatus", changeEventStatus);
socket.on("videoStatus", changeVideoStatus);
socket.on("pollStatus", changePollStatus);
socket.on("pollVisibility", changePollVisibility);
...
socket.on("contestStatus", changeContestStatus);
socket.on("contestQuestionStatus", changeContestQuestionStatus);
